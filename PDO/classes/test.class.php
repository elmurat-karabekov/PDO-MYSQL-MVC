<?php
/*
    Test class extend from Dbh so we can access connection method from Dbh
*/
...
class Test extends Dbh
{
    ...
    public function setUsersStmt($firstname, $lastname, $dateofbith){
        $sql = "INSERT INTO users(users_firstname, users_lastname, users_dateofbirth)   VALUES (?, ?, ?)";
        $stmt = $this->connect()->prepare($sql);
        $stmt->execute([$firstname, $lastname, $dateofbith]);
    }
}
